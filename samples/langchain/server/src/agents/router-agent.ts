...
1. Use the \`get_retrieval\` tool to inspect the current state snapshot properties to determine the necessary agent(s) to execute in order to satisfy the user's prompt.
