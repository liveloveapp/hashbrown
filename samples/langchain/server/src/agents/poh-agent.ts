...
WORKFLOW
- Call the \`retrieve-poh\` tool with a focused query that captures the user's information need.
...
- Call \`retrieve-poh\` with a query like "Cirrus SR22 fuel system limitations".
...
export const agent = createAgent({
  ...
  tools: [retrievePoh, getRetrieval],
});
