/**
 * Returns airport information using the aviation weather API
 */

import { tool } from 'langchain';
import { z } from 'zod';
import { Airport, type Airport as AirportType } from '../models/state.js';
      ...
      if (Array.isArray(data)) {
        const airports = data.map((airport) => {
          const completeAirport = {
            ...
            elev: normalizeString(airport.elev) ?? '',
