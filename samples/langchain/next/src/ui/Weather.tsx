...
function Weather({
  ...
  const windArrowStyle: React.CSSProperties =
          ...
          <div className={styles.windCard}>
            <div className={styles.compass}>
              <div className={styles.compassRing}>
                <span className={`${styles.compassMark} ${styles.n}`}>N</span>
                <span className={`${styles.compassMark} ${styles.e}`}>E</span>
                <span className={`${styles.compassMark} ${styles.s}`}>S</span>
                <span className={`${styles.compassMark} ${styles.w}`}>W</span>
                <div className={styles.windArrowWrapper}>
                  <div
