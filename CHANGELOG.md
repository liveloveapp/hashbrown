...
- **angular:** export `JsonParserRef` and `ImperativeJsonParserRef`, the types `injectJsonParser` and `injectImperativeJsonParser` return ([#580](https://github.com/liveloveapp/hashbrown/pull/580))
