...
- **angular:** consume ui wrapper schema ([7baed2e](https://github.com/liveloveapp/project-cassini/commit/7baed2e))
...
- **core:** return wrapper ui schema and examples ([7328a9b](https://github.com/liveloveapp/project-cassini/commit/7328a9b))
...
- **react:** consume ui wrapper schema ([9cbc9d4](https://github.com/liveloveapp/project-cassini/commit/9cbc9d4))
