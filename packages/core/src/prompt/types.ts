...
export type ExampleInjectionMode = 'inline' | 'placeholder' | 'none';

export type CompileOptions = {
  exampleInjection?: ExampleInjectionMode;
};

export type SystemPrompt = {
  compile: (components: readonly any[], options?: CompileOptions) => string;
  examples: HBTree[];
