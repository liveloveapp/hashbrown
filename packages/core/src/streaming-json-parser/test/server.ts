...
const TEST_JSON = [
  {
    choices: [
      {
        index: 0,
        delta: { tool_calls: [{ function: { arguments: '{"na' }, index: 0 }] },
        finish_reason: null,
      },
    ],
  },
  {
    choices: [
      {
        index: 0,
        delta: { tool_calls: [{ function: { arguments: 'me": ' }, index: 0 }] },
        finish_reason: null,
      },
    ],
  },
    ...
    choices: [
      {
        index: 0,
        delta: {
          tool_calls: [{ function: { arguments: '"build' }, index: 0 }],
        },
        finish_reason: null,
      },
    ],
  },
  {
    choices: [
      {
        index: 0,
        delta: { tool_calls: [{ function: { arguments: 'ing"' }, index: 0 }] },
        finish_reason: null,
      },
    ],
  },
  {
    choices: [
      {
        index: 0,
        delta: { tool_calls: [{ function: { arguments: ', "va' }, index: 0 }] },
        finish_reason: null,
      },
    ],
  },
    ...
    choices: [
      {
        index: 0,
        delta: {
          tool_calls: [{ function: { arguments: 'lue": ' }, index: 0 }],
        },
        finish_reason: null,
      },
    ],
  },
  {
    choices: [
      {
        index: 0,
        delta: { tool_calls: [{ function: { arguments: '1638' }, index: 0 }] },
        finish_reason: null,
      },
    ],
  },
  {
    choices: [
      {
        index: 0,
        delta: { tool_calls: [{ function: { arguments: '23}' }, index: 0 }] },
        finish_reason: null,
      },
    ],
  },
  {
    choices: [
      {
        index: 0,
        delta: { tool_calls: [{ function: { arguments: '{"na' }, index: 1 }] },
        finish_reason: null,
      },
    ],
  },
  {
    choices: [
      {
        index: 0,
        delta: { tool_calls: [{ function: { arguments: 'me": ' }, index: 1 }] },
        finish_reason: null,
      },
    ],
  },
    ...
    choices: [
      {
        index: 0,
        delta: {
          tool_calls: [{ function: { arguments: '"build' }, index: 1 }],
        },
        finish_reason: null,
      },
    ],
  },
  {
    choices: [
      {
        index: 0,
        delta: { tool_calls: [{ function: { arguments: 'ing_' }, index: 1 }] },
        finish_reason: null,
      },
    ],
  },
  {
    choices: [
      {
        index: 0,
        delta: { tool_calls: [{ function: { arguments: 'detai' }, index: 1 }] },
        finish_reason: null,
      },
    ],
  },
    ...
    choices: [
      {
        index: 0,
        delta: {
          tool_calls: [{ function: { arguments: 'ls", "' }, index: 1 }],
        },
        finish_reason: null,
      },
    ],
  },
  {
    choices: [
      {
        index: 0,
        delta: { tool_calls: [{ function: { arguments: 'valu' }, index: 1 }] },
        finish_reason: null,
      },
    ],
  },
  {
    choices: [
      {
        index: 0,
        delta: { tool_calls: [{ function: { arguments: 'e": [' }, index: 1 }] },
        finish_reason: null,
      },
    ],
  },
    ...
    choices: [
      {
        index: 0,
        delta: {
          tool_calls: [{ function: { arguments: '"occup' }, index: 1 }],
        },
        finish_reason: null,
      },
    ],
  },
  {
    choices: [
      {
        index: 0,
        delta: { tool_calls: [{ function: { arguments: 'ancy' }, index: 1 }] },
        finish_reason: null,
      },
    ],
  },
  {
    choices: [
      {
        index: 0,
        delta: { tool_calls: [{ function: { arguments: '", "o' }, index: 1 }] },
        finish_reason: null,
      },
    ],
  },
    ...
    choices: [
      {
        index: 0,
        delta: {
          tool_calls: [{ function: { arguments: 'ccupan' }, index: 1 }],
        },
        finish_reason: null,
      },
    ],
  },
  {
    choices: [
      {
        index: 0,
        delta: { tool_calls: [{ function: { arguments: 'cySc' }, index: 1 }] },
        finish_reason: null,
      },
    ],
  },
  {
    choices: [
      {
        index: 0,
        delta: { tool_calls: [{ function: { arguments: 'hedul' }, index: 1 }] },
        finish_reason: null,
      },
    ],
  },
...
let argsComposite = '';
TEST_JSON.forEach((obj) => {
  console.log(JSON.stringify(obj.choices[0], null, 4));
  argsComposite += (obj.choices[0].delta as any).tool_calls[0].function
    .arguments;
});

console.log(argsComposite);
