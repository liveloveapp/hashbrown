...
`@hashbrownai/openai` is the Node adapter for OpenAI. It maps an AG-UI run from Hashbrown's React or Angular packages to the OpenAI SDK and streams AG-UI events back. Your server keeps the API key.
