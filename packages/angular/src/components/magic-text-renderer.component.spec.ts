...
function renderComponent(
  ...
  component: HbMagicTextRendererComponent & {
    fragments(): MagicTextFragment[];
  };
  innerText: string;
} {
  TestBed.configureTestingModule({
    imports: [HbMagicTextRendererComponent],
  });

  const fixture = TestBed.createComponent(HbMagicTextRendererComponent);
  const component =
    fixture.componentInstance as HbMagicTextRendererComponent & {
      fragments(): MagicTextFragment[];
    };
...
describe('HbMagicTextRendererComponent whitespace', () => {
...
describe('HbMagicTextRendererComponent inline markdown parsing', () => {
