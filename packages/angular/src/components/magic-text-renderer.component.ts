...
@Component({
  ...
  template: `
    ...
    @for (fragment of fragments(); track fragment.key; let i = $index) {
      ...
      <span
        class="hb-fragment"
        [class.hb-fragment--provisional]="fragment.state === 'provisional'"
        [class.hb-fragment--static]="fragment.isStatic"
...
export class MagicText {
  ...
  protected fragments = computed(() => prepareMagicText(this.text()).fragments);
