...
`@hashbrownai/bedrock` is the Node adapter for Amazon Bedrock. It maps an AG-UI run from Hashbrown's React or Angular packages to the Amazon Bedrock SDK and streams AG-UI events back. Your server keeps the API key.
