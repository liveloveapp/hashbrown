...
Tasks 2 and 4–6 have not started. See the dated evidence at the top of
...
live inside `server/src/contracts.ts`. The build type-checks; HTTP startup,
opaque cookie assignment, and B4 thread authorization remain pending. These
