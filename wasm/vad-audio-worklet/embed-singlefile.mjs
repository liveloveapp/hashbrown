...
const loaderSourceInlined = loaderSource.replace(
  /export default createAudioWorkletModule;?\s*$/,
  'const baseFactory = createAudioWorkletModule;',
);

if (loaderSourceInlined === loaderSource) {
  throw new Error(
    'Expected export default createAudioWorkletModule; in loader source.',
  );
}
