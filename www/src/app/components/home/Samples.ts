...
@Component({
  ...
  template: `
    <div class="bleed">
      ...
      >
        <div class="header">
          <h2>Run LLM-generated JS (safely)</h2>
          <p>
            Leverage the code authoring intelligence of today's models.
          ...
          <div class="button" wwwSquircle="8">
            ...
            <div class="text">
              ...
              <small
                >Safely execute JS code generated by the model in the
                browser.</small
              >
            </div>
            <www-chevron-right height="32px" width="32px" />
      ...
      >
        <div class="header">
          <h2>Stream and Eagerly Parse Responses</h2>
          <p>
            Large language models can be slow. Hashbrown streams and eagerly
            parses JSON responses from the model using our LLM-optimized schema
            language.
          </p>
          <div class="button" wwwSquircle="8">
            <www-send />
            <div class="text">
              ...
              <small
                >Use Skillet for built-in streaming and eager JSON
                parsing.</small
              >
            </div>
            <www-chevron-right height="32px" width="32px" />
