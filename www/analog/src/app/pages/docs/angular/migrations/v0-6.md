...
Hashbrown's Writer provider package is no longer published, and its known-model ID list was removed from core. Move to another supported provider, or wrap Writer's SDK in a [custom provider](/docs/angular/platform/custom).
