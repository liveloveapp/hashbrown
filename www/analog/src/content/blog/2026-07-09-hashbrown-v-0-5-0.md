...
_Update: the Fast Food example has since been retired. See [Invoicing](/samples) for the maintained example, or the [historical Fast Food source](https://github.com/liveloveapp/hashbrown/tree/43e40ba5/samples/fast-food)._
...
Read the [React migration notes](/docs/react/migrations/v0-5) or [Angular migration notes](/docs/angular/migrations/v0-5) for the details.
