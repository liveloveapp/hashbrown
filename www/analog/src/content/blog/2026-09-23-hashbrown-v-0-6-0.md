...
Here's the short version. In v0.5, Hashbrown talked to your server using its own binary frame protocol. In v0.6, Hashbrown speaks [AG-UI](https://docs.ag-ui.com), the open protocol for connecting agents to user interfaces. Your server receives an AG-UI run and streams AG-UI events back.
...
The new Migrations section of the docs walks through every change for [React](/docs/react/migrations/v0-6) and [Angular](/docs/angular/migrations/v0-6), and the prompt above handles the mechanical edits.
