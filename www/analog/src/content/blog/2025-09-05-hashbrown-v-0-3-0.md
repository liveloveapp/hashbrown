...
_Update: the Spotify example has been retired. Its [historical source](https://github.com/liveloveapp/hashbrown/tree/43e40ba5/samples/spotify) remains available; [Invoicing](/samples) is the maintained example._

Overall, we are choosing to exercise restraint in our MCP API surface with this limited integration. It’s not clear to us how applicable MCP will be for creating apps with generative UI. If you have use cases for MCP with Hashbrown, we would love to hear from you to help shape future MCP APIs. Share feedback in [GitHub Issues](https://github.com/liveloveapp/hashbrown/issues).
